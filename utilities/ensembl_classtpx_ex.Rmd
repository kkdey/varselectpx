...
The main problem we address using `varselectpx` is variable selection in topic models. From 
...
We take the first and the last entries and define the reduced counts matrix.
...
Topic_clus <- classtpx::class_topics(counts,                                                                       K=2,
                                      known_indices=known_indices,                                                  omega_known = omega_known,                                                    tol=0.1);
